...
#   font deps
    freetype-dev fontconfig-dev libc-dev; \
    echo "Build ICU ..."; \
    ...
    wget -q http://dl-cdn.alpinelinux.org/alpine/v3.16/main/$(uname -m)/libexecinfo-1.1-r1.apk; \
    wget -q http://dl-cdn.alpinelinux.org/alpine/v3.16/main/$(uname -m)/libexecinfo-dev-1.1-r1.apk; \
    apk add --quiet ./libexecinfo-1.1-r1.apk ./libexecinfo-dev-1.1-r1.apk; \
    cd /tmp/phantomjs; \
